...
pileupCalc.py -i /afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions12/8TeV/Reprocessing/Cert_190456-208686_8TeV_22Jan2013ReReco_Collisions12_JSON.txt --calcMode=observed --inputLumiJSON=/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions12/8TeV/PileUp/pileup_latest.txt --minBiasXsec=69400 --maxPileupBin=60 --numPileupBins=60 --verbose  -o $CMSSW_BASE/src/CommonTools/MyTools/data/pileUpFileData_2012observedPixel.root $CMSSW_BASE/src/CommonTools/MyTools/data/pileUpFileData_2012observedPixel.root
