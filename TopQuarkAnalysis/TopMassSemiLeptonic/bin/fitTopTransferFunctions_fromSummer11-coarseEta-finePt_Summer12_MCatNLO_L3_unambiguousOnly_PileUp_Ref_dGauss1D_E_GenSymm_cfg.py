...
fitTopTransferFunctions = cms.PSet(
    ...
    io = cms.PSet(
        ...
        plot = cms.bool(True),
        outputFile = cms.string('file:/afs/cern.ch/work/v/vadler/cms/Top/CMSSW_5_3_13/output/fitTopTransferFunctions_fromSummer11-coarseEta-finePt_Summer12_MCatNLO_L3_unambiguousOnly_PileUp_1D.root'),
        ...
        pathPlots = cms.string('/afs/cern.ch/work/v/vadler/cms/Top/CMSSW_5_3_13/output/plots/fitTopTransferFunctions/fitTopTransferFunctions_fromSummer11-coarseEta-finePt_Summer12_MCatNLO_L3_unambiguousOnly_PileUp_Ref_dGauss1D_'),
        ...
        inputFile = cms.string('file:/afs/cern.ch/work/v/vadler/cms/Top/CMSSW_5_3_13/output/analyzeHitFit_fromSummer11-coarseEta-finePt_Summer12_MCatNLO_L3_unambiguousOnly.root')
    ),
    objects = cms.PSet(
        BJet = cms.PSet(
