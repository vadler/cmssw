...
fitTopTransferFunctions = cms.PSet(
    ...
    io = cms.PSet(
        ...
        sample = cms.string('Summer12_MCatNLO_L3_unambiguousOnlyLooseR'),
        pathPlots = cms.string('/afs/cern.ch/work/v/vadler/cms/Top/CMSSW_5_3_13/output/plots/fitTopTransferFunctions/fitTopTransferFunctions_fromSummer11-coarseEta_Summer12_MCatNLO_L3_unambiguousOnlyLooseR_Ref_'),
