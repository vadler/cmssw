...
fitTopTransferFunctions = cms.PSet(
    ...
    io = cms.PSet(
        ...
        plot = cms.bool(True),
        outputFile = cms.string('file:/afs/cern.ch/work/v/vadler/cms/Top/CMSSW_5_3_13/output/fitTopTransferFunctions_fromSummer11-coarseEta_Summer12_MCatNLO_L3_unambiguousOnly_bTag.root'),
        ...
        sample = cms.string('Summer12_MCatNLO_L3_unambiguousOnly_bTag'),
        pathPlots = cms.string('/afs/cern.ch/work/v/vadler/cms/Top/CMSSW_5_3_13/output/plots/fitTopTransferFunctions/fitTopTransferFunctions_fromSummer11-coarseEta_Summer12_MCatNLO_L3_unambiguousOnly_bTag_Ref_'),
