...
fitTopTransferFunctions = cms.PSet(
    ...
    io = cms.PSet(
        ...
        pathPlots = cms.string('/afs/cern.ch/work/v/vadler/cms/Top/CMSSW_5_3_13/output/plots/fitTopTransferFunctions/fitTopTransferFunctions_fromSummer11-coarseEta_Summer12_MadGraph_UnbiasedE_L3_unambiguousOnly_PileUp_Ref_dGauss_'),
