...
fitTopTransferFunctions = cms.PSet(
    ...
    io = cms.PSet(
        ...
        plot = cms.bool(True),
        outputFile = cms.string('file:/afs/cern.ch/work/v/vadler/cms/Top/CMSSW_5_3_13/output/fitTopTransferFunctions_fromSummer11-coarseEta_Summer12_MadGraph_newElec_noVeto_L3_unambiguousOnly_PileUp.root'),
        ...
        sample = cms.string('Summer12_MadGraph_newElec_noVeto_L3_unambiguousOnly'),
        pathPlots = cms.string('/afs/cern.ch/work/v/vadler/cms/Top/CMSSW_5_3_13/output/plots/fitTopTransferFunctions/fitTopTransferFunctions_fromSummer11-coarseEta_Summer12_MadGraph_newElec_noVeto_L3_unambiguousOnly_PileUp_Ref_sGauss_'),
        ...
        inputFile = cms.string('file:/afs/cern.ch/work/v/vadler/cms/Top/CMSSW_5_3_13/output/analyzeHitFit_fromSummer11-coarseEta_Summer12_MadGraph_newElec_noVeto_L3_unambiguousOnly.root')
    ),
    objects = cms.PSet(
        Mu = cms.PSet(
