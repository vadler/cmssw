...
void AnalyzeHitFit::endJob()
{
  ...
  if ( plot_ ) {
    ...
    for ( unsigned iCat = 0; iCat < objCats_.size(); ++iCat ) {
      ...
      catData_.at( iCat )->Draw( "BinPt", "BinPt>-1" );
      c1.Print( std::string( pathPlots_ + cat + "_BinPt.png" ).c_str() );
      ...
      catData_.at( iCat )->Draw( "BinEtaPt", "BinEtaPt>-1" );
      c1.Print( std::string( pathPlots_ + cat + "_BinEtaPt.png" ).c_str() );
      catData_.at( iCat )->Draw( "BinEtaPt:NPVTrue", "BinEtaPt>-1", "ColZ" );
      c1.Print( std::string( pathPlots_ + cat + "_BinEtaPt-NPVTrue.png" ).c_str() );
      ...
      catData_.at( iCat )->Draw( "BinEtaSymmPt", "BinEtaSymmPt>-1" );
      c1.Print( std::string( pathPlots_ + cat + "_BinEtaSymmPt.png" ).c_str() );
      catData_.at( iCat )->Draw( "BinEtaSymmPt:NPVTrue", "BinEtaSymmPt>-1", "ColZ" );
      c1.Print( std::string( pathPlots_ + cat + "_BinEtaSymmPt-NPVTrue.png" ).c_str() );
      ...
      catData_.at( iCat )->Draw( "BinPtAlt", "BinPtAlt>-1" );
      c1.Print( std::string( pathPlots_ + cat + "_BinPtAlt.png" ).c_str() );
      ...
      catData_.at( iCat )->Draw( "BinEtaPtAlt", "BinEtaPtAlt>-1" );
      c1.Print( std::string( pathPlots_ + cat + "_BinEtaPtAlt.png" ).c_str() );
      catData_.at( iCat )->Draw( "BinEtaPtAlt:NPVTrue", "BinEtaPtAlt>-1", "ColZ" );
      c1.Print( std::string( pathPlots_ + cat + "_BinEtaAPtlt-NPVTrue.png" ).c_str() );
      ...
      catData_.at( iCat )->Draw( "BinEtaSymmPtAlt", "BinEtaSymmPtAlt>-1" );
      c1.Print( std::string( pathPlots_ + cat + "_BinEtaSymmPtAlt.png" ).c_str() );
      catData_.at( iCat )->Draw( "BinEtaSymmPtAlt:NPVTrue", "BinEtaSymmPtAlt>-1", "ColZ" );
      c1.Print( std::string( pathPlots_ + cat + "_BinEtaSymmPtAlt-NPVTrue.png" ).c_str() );
      if ( cat == "UdscJet" || cat == "BJet" ) {
        ...
        catData_.at( iCat )->Draw( "BinPtGenJet", "BinPtGenJet>-1" );
        c1.Print( std::string( pathPlots_ + cat + "_BinPtGenJet.png" ).c_str() );
        ...
        catData_.at( iCat )->Draw( "BinEtaPtGenJet", "BinEtaPtGenJet>-1" );
        c1.Print( std::string( pathPlots_ + cat + "_BinEtaPtGenJet.png" ).c_str() );
        catData_.at( iCat )->Draw( "BinEtaPtGenJet:NPVTrue", "BinEtaPtGenJet>-1", "ColZ" );
        c1.Print( std::string( pathPlots_ + cat + "_BinEtaPtGenJet-NPVTrue.png" ).c_str() );
        ...
        catData_.at( iCat )->Draw( "BinEtaSymmPtGenJet", "BinEtaSymmPtGenJet>-1" );
        c1.Print( std::string( pathPlots_ + cat + "_BinEtaSymmPtGenJet.png" ).c_str() );
        catData_.at( iCat )->Draw( "BinEtaSymmPtGenJet:NPVTrue", "BinEtaSymmPtGenJet>-1", "ColZ" );
        c1.Print( std::string( pathPlots_ + cat + "_BinEtaSymmPtGenJet-NPVTrue.png" ).c_str() );
        ...
        catData_.at( iCat )->Draw( "BinPtGenJetAlt", "BinPtGenJetAlt>-1" );
        c1.Print( std::string( pathPlots_ + cat + "_BinPtGenJetAlt.png" ).c_str() );
        ...
        catData_.at( iCat )->Draw( "BinEtaPtGenJetAlt", "BinEtaPtGenJetAlt>-1" );
        c1.Print( std::string( pathPlots_ + cat + "_BinEtaPtGenJetAlt.png" ).c_str() );
        catData_.at( iCat )->Draw( "BinEtaPtGenJetAlt:NPVTrue", "BinEtaPtGenJetAlt>-1", "ColZ" );
        c1.Print( std::string( pathPlots_ + cat + "_BinEtaPtGenJetAlt-NPVTrue.png" ).c_str() );
        ...
        catData_.at( iCat )->Draw( "BinEtaSymmPtGenJetAlt", "BinEtaSymmPtGenJetAlt>-1" );
        c1.Print( std::string( pathPlots_ + cat + "_BinEtaSymmPtGenJetAlt.png" ).c_str() );
        catData_.at( iCat )->Draw( "BinEtaSymmPtGenJetAlt:NPVTrue", "BinEtaSymmPtGenJetAlt>-1", "ColZ" );
        c1.Print( std::string( pathPlots_ + cat + "_BinEtaSymmPtGenJetAlt-NPVTrue.png" ).c_str() );
      }
      ...
      catData_.at( iCat )->Draw( "BinPtGen", "BinPtGen>-1" );
      c1.Print( std::string( pathPlots_ + cat + "_BinPtGen.png" ).c_str() );
      ...
      catData_.at( iCat )->Draw( "BinEtaPtGen", "BinEtaPtGen>-1" );
      c1.Print( std::string( pathPlots_ + cat + "_BinEtaPtGen.png" ).c_str() );
      catData_.at( iCat )->Draw( "BinEtaPtGen:NPVTrue", "BinEtaPtGen>-1", "ColZ" );
      c1.Print( std::string( pathPlots_ + cat + "_BinEtaPtGen-NPVTrue.png" ).c_str() );
      ...
      catData_.at( iCat )->Draw( "BinEtaSymmPtGen", "BinEtaSymmPtGen>-1" );
      c1.Print( std::string( pathPlots_ + cat + "_BinEtaSymmPtGen.png" ).c_str() );
      catData_.at( iCat )->Draw( "BinEtaSymmPtGen:NPVTrue", "BinEtaSymmPtGen>-1", "ColZ" );
      c1.Print( std::string( pathPlots_ + cat + "_BinEtaSymmPtGen-NPVTrue.png" ).c_str() );
