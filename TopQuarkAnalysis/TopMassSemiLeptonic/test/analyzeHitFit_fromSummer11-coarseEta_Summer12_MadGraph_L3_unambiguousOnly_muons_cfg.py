...
process.analyzeHitFit = cms.EDAnalyzer("AnalyzeHitFit",
    ...
    pathPlots = cms.string('/afs/cern.ch/user/v/vadler/work/cms/Top/CMSSW_5_3_13/output/plots/analyzeHitFit/analyzeHitFit_fromSummer11-coarseEta_Summer12_MadGraph_L3_unambiguousOnly_muons_'),
...
process.matcherSequenceBase = cms.Sequence(process.makeTtSemiLepEventMCMatchMuons)


process.matcherSequenceReference = cms.Sequence(process.makeTtSemiLepEventReferenceMuons)
...
process.matcherSequence = cms.Sequence(process.makeTtSemiLepEventHitFitMuons)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('/afs/cern.ch/user/v/vadler/work/cms/Top/CMSSW_5_3_13/output/analyzeHitFit_fromSummer11-coarseEta_Summer12_MadGraph_L3_unambiguousOnly_muons.root')
)
