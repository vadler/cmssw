...
era    = 'Summer11'
sample = 'Summer12_MadGraph_UnbiasedE'
#sample = 'Summer12_MCatNLO_UnbiasedE'
...
ttSemiLepHypMuons     = 'selectedPatMuonsUnbiasedMCMatch'
ttSemiLepHypElectrons = 'selectedPatElectronsUnbiasedMCMatch'
ttSemiLepHypJets      = 'selectedPatJetsUnbiasedMCMatch'
skimProcess           = 'SKIM'
patMuons     = 'selectedPatMuonsUnbiasedHitFit'
patElectrons = 'selectedPatElectronsUnbiasedHitFit'
patJets      = 'selectedPatJetsUnbiasedHitFit'
patMuonsReference     = 'referencePatMuonsUnbiased'
patElectronsReference = 'referencePatElectronsUnbiased'
patJetsReference      = 'referencePatJetsUnbiased'
patMETs      = 'patMETs'
jecLevels = [ 'L1FastJet'
            , 'L2Relative'
            , 'L3Absolute'
