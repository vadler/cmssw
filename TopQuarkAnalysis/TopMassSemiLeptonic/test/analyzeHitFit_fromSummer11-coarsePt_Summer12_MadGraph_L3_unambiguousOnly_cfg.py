...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('/afs/cern.ch/user/v/vadler/cms/Top/CMSSW_5_3_11/output/analyzeHitFit_fromSummer11-coarsePt_Summer12_MadGraph_L3_unambiguousOnly.root')
)
