...
process.analyzeHitFit = cms.EDAnalyzer("AnalyzeHitFit",
    ...
    udscJetPtBins = cms.vdouble(30.0, 50.0, 70.0,
        90.0, 120.0,
        200.0, 500.0),
    udscJetEtaBins = cms.vdouble(),
    muonPtBins = cms.vdouble(20.0, 33.0, 47.0,
        62.0, 86.0,
        200.0, 400.0),
    pileUpFileMCTrue = cms.FileInPath('CommonTools/MyTools/data/pileUpFileMC_Fall11.root'),
    electronPtBins = cms.vdouble(20.0, 33.0, 47.0,
        62.0, 86.0,
        200.0, 400.0),
    ...
    bJetPtBins = cms.vdouble(30.0, 50.0, 70.0,
        90.0, 120.0,
        200.0, 500.0),
