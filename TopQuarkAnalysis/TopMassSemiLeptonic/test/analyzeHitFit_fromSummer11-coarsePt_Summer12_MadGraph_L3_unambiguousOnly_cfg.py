...
process.analyzeHitFit = cms.EDAnalyzer("AnalyzeHitFit",
    ...
    pathPlots = cms.string('/afs/cern.ch/user/v/vadler/cms/Top/CMSSW_5_3_11/output/plots/analyzeHitFit/analyzeHitFit_fromSummer11-coarsePt_Summer12_MadGraph_L3_unambiguousOnly_'),
    metPtBins = cms.vdouble(10.0, 29.0, 44.0,
        59.0, 80.0,
        122.0, 300.0),
    ...
    udscJetPtBins = cms.vdouble(0.0, 30.0, 50.0, 70.0,
        90.0, 120.0,
        200.0, 500.0),
    udscJetEtaBins = cms.vdouble(),
    muonPtBins = cms.vdouble(0.0, 20.0, 33.0, 47.0,
        62.0, 86.0,
        200.0, 400.0),
    pileUpFileMCTrue = cms.FileInPath('CommonTools/MyTools/data/pileUpFileMC_Fall11.root'),
    electronPtBins = cms.vdouble(0.0, 20.0, 33.0, 47.0,
        62.0, 86.0,
        200.0, 400.0),
    ...
    bJetPtBins = cms.vdouble(0.0, 30.0, 50.0, 70.0,
        90.0, 120.0,
        200.0, 500.0),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('/afs/cern.ch/user/v/vadler/work/cms/Top/CMSSW_5_3_13/output/analyzeHitFit_fromSummer11-coarsePt_Summer12_MadGraph_L3_unambiguousOnly.root')
)
