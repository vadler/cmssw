...
process.analyzeHitFit = cms.EDAnalyzer("AnalyzeHitFit",
    ...
    pathPlots = cms.string('/afs/cern.ch/user/v/vadler/cms/Top/CMSSW_5_3_11/output/plots/analyzeHitFit/analyzeHitFit_fromSummer11_Summer12_MCatNLO_L3_unambiguousOnly_allJets_'),
    ...
    udscJetPtBins = cms.vdouble(30.0, 40.0, 50.0, 60.0, 70.0,
        ...
        200.0, 300.0, 500.0),
    jetPtBins = cms.vdouble(30.0, 40.0, 50.0, 60.0, 70.0,
        80.0, 90.0, 100.0, 120.0, 150.0,
        200.0, 300.0, 500.0),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('/afs/cern.ch/user/v/vadler/work/cms/Top/CMSSW_5_3_13/output/analyzeHitFit_fromSummer11_Summer12_MCatNLO_L3_unambiguousOnly_allJets.root')
)
