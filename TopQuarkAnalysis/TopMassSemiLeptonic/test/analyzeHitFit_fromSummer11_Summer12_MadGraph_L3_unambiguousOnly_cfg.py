...
process.analyzeHitFit = cms.EDAnalyzer("AnalyzeHitFit",
    ...
    pathPlots = cms.string('/afs/cern.ch/user/v/vadler/cms/Top/CMSSW_5_3_11/output/plots/analyzeHitFit/analyzeHitFit_fromSummer11_Summer12_MadGraph_L3_unambiguousOnly_'),
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('/afs/cern.ch/user/v/vadler/work/cms/Top/CMSSW_5_3_13/output/analyzeHitFit_fromSummer11_Summer12_MadGraph_L3_unambiguousOnly.root')
)
