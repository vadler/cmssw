...
electronUsePV        = False
electronSelectBase   = 'ecalDrivenMomentum.energy > 20. && (chargedHadronIso+max(0.,neutralHadronIso+photonIso-1.*userIsolation("User1Iso")))/ecalDrivenMomentum.pt < 0.15 && abs(ecalDrivenMomentum.eta) < 3.0 && (1. >= electronID("mvaTrigV0") && electronID("mvaTrigV0") >= 0.)'
...
electronSelectSignal = 'ecalDrivenMomentum.energy > 30. && abs(ecalDrivenMomentum.eta) < 2.5 && !(1.4442 < abs(superCluster.eta) && abs(superCluster.eta) < 1.5660) && abs(dB) < 0.02 && electronID("mvaTrigV0") > 0.5 && (chargedHadronIso+max(0.,neutralHadronIso+photonIso-1.0*userIsolation("User1Iso")))/ecalDrivenMomentum.pt < 0.1 && passConversionVeto && gsfTrack.trackerExpectedHitsInner.numberOfHits <= 0'
electronSelectUnbiasedBase   = '(chargedHadronIso+max(0.,neutralHadronIso+photonIso-1.*userIsolation("User1Iso")))/ecalDrivenMomentum.pt < 0.15 && abs(ecalDrivenMomentum.eta) < 3.0 && (1. >= electronID("mvaTrigV0") && electronID("mvaTrigV0") >= 0.)'
electronSelectUnbiasedHitFit = electronSelectUnbiasedBase + ' && abs(ecalDrivenMomentum.eta) < 2.5 && passConversionVeto'
electronSelectUnbiased       = electronSelectUnbiasedBase + ' && abs(ecalDrivenMomentum.eta) < 2.5'
electronSelectUnbiasedSignal = 'abs(ecalDrivenMomentum.eta) < 2.5 && !(1.4442 < abs(superCluster.eta) && abs(superCluster.eta) < 1.5660) && abs(dB) < 0.02 && electronID("mvaTrigV0") > 0.5 && (chargedHadronIso+max(0.,neutralHadronIso+photonIso-1.0*userIsolation("User1Iso")))/ecalDrivenMomentum.pt < 0.1 && passConversionVeto && gsfTrack.trackerExpectedHitsInner.numberOfHits <= 0'
